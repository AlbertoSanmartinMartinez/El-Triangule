...
class ListResponseNotification(BaseModel):
    """
    ...
    order: OrderParams
    __properties: ClassVar[List[str]] = ["items", "pagination", "order"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [Notification.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "pagination": PaginationParams.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None,
            "order": OrderParams.from_dict(obj["order"]) if obj.get("order") is not None else None
        })
        return _obj
